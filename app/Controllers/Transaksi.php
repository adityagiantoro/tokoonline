...
class Transaksi extends BaseController
{
    ...
    public function invoice()
    {
        ...
        $this->sendEmail($attachment, 'giantoroadit01@gmail.com', 'Invoice', $message);

        return redirect()->to(site_url('transaksi/index'));
    }
    private function sendEmail($attachment, $to, $title, $message)
    {
        $this->email->setFrom('giantoroadit01@gmail.com', 'smandel2017');
        $this->email->setTo($to);
    ...
    // {
    //     $this->email->setFrom('giantoroadit01@gmail.com', 'smandel2017');
    //     $this->email->setTo($giantoroadit01@gmail.com);
